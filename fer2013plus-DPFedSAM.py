...
if __name__ == '__main__':
    ...
    # IID
    data_obj = DatasetObject(dataset='fer2013_plus', n_clnt=n_client, seed=20, rule='iid',
                             data_path=data_path)

    model_name = 'fer2013_plus_LeNet'
    ...
    [avg_cld_mdls, trn_cur_cld_perf, tst_cur_cld_perf] = train_DPFedSAM(data_obj=data_obj, act_prob=act_prob,
                                                                       ...
                                                                       batch_size=batch_size, rho=rho,epoch=epoch,n_minibatch=n_minibatch,
    ...
    data_obj = DatasetObject(dataset='fer2013_plus', n_clnt=n_client, seed=20, rule='Dirichlet',rule_arg=0.3,
                             data_path=data_path)
    ...
    data_obj = DatasetObject(dataset='fer2013_plus', n_clnt=n_client, seed=20, rule='Dirichlet',rule_arg=0.6,
                             data_path=data_path)
