...
if __name__ == '__main__':
    ...
    data_obj = DatasetObject(dataset='CIFAR100', n_client=n_client, seed=20, rule='Pathological',rule_arg=20,
                             unbalanced_sgm=0,
                             data_path=data_path)
    ...
    data_obj = DatasetObject(dataset='CIFAR100', n_client=n_client, seed=20, rule='Pathological',rule_arg=10,
                             unbalanced_sgm=0,
                             data_path=data_path)
