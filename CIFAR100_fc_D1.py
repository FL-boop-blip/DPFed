...
def main():
    ...
    [avg_cld_mdls, trn_cur_cld_perf] = train_MoFedSAM(data_obj=data_obj, act_prob=act_prob,
                                        learning_rate=learning_rate, rho=rho,batch_size=batch_size, n_minibatch=n_minibatch,epoch=epoch,
                                        com_amount=com_amount, print_per=print_per, weight_decay=weight_decay,
    ...
    [fed_mdls_sel, tst_perf_sel] = train_FedGamma(data_obj=data_obj, act_prob=act_prob,
                                                  ...
                                                  suffix=suffix,
                                                  trial=True, data_path=data_path,
    ...
    [fed_mdls_sel, tst_perf_sel] = train_FedSGAM_KL(data_obj=data_obj, act_prob=act_prob,
                                                    learning_rate=learning_rate,
                                                    batch_size=batch_size, epoch=epoch,
                                                    com_amount=com_amount, print_per=print_per,
                                                    weight_decay=weight_decay,
...
if __name__ == '__main__':
    ...
    freeze_support()
    main()
# data_obj = DatasetObject(dataset='mnist', n_client=n_client, seed=20,  unbalanced_sgm=0,rule='Dirichlet', rule_arg=0.3, data_path=data_path)
# # data_obj = DatasetObject(dataset='CIFAR100', n_client=n_client, seed=23, rule='iid', unbalanced_sgm=0.3, data_path=data_path)
#
# # Dirichlet (0.6)
# # data_obj = DatasetObject(dataset='CIFAR100', n_client=n_client, seed=20, unbalanced_sgm=0, rule='Drichlet', rule_arg=0.6, data_path=data_path)
...
# rho = 0.5
#
# [fed_mdls_sel, tst_perf_sel] = train_DPFedSGAM_KL(data_obj=data_obj, act_prob=act_prob,
#                                                 learning_rate=learning_rate,
#                                                 batch_size=batch_size, epoch=epoch,
#                                                 com_amount=com_amount, print_per=print_per,
#                                                 weight_decay=weight_decay,
...
#
#
# data_obj = DatasetObject(dataset='mnist', n_client=n_client, seed=20,  unbalanced_sgm=0,rule='Dirichlet', rule_arg=0.6, data_path=data_path)
# # data_obj = DatasetObject(dataset='CIFAR100', n_client=n_client, seed=23, rule='iid', unbalanced_sgm=0.3, data_path=data_path)
#
# # Dirichlet (0.6)
# # data_obj = DatasetObject(dataset='CIFAR100', n_client=n_client, seed=20, unbalanced_sgm=0, rule='Drichlet', rule_arg=0.6, data_path=data_path)
...
# rho = 0.5
#
# [fed_mdls_sel, tst_perf_sel] = train_DPFedSGAM(data_obj=data_obj, act_prob=act_prob,
#                                                 learning_rate=learning_rate,
#                                                 batch_size=batch_size, epoch=epoch,
#                                                 com_amount=com_amount, print_per=print_per,
#                                                 weight_decay=weight_decay,
...
# rho = 0.5
#
# [avg_cld_mdls, trn_cur_cld_perf, tst_cur_cld_perf] = train_DPFedSAM(data_obj=data_obj, act_prob=act_prob,
#                                     learning_rate=learning_rate, rho=rho,batch_size=batch_size, n_minibatch=n_minibatch,epoch=epoch,
#                                     com_amount=com_amount, print_per=print_per, weight_decay=weight_decay,
#                                     model_func=model_func, init_model=init_model, alpha_coef=alpha_coef,
...
# print_per = 5
#
# [fed_mdls_sel, trn_perf_sel] = train_DPFedAvg(data_obj=data_obj, act_prob=act_prob ,
#                                     learning_rate=learning_rate, batch_size=batch_size, epoch=epoch,
#                                     com_amount=com_amount, print_per=print_per, weight_decay=weight_decay,
#                                     model_func=model_func, init_model=init_model,
#                                     sch_step=1, sch_gamma=1, save_period=save_period, suffix=suffix,
...
# data_obj = DatasetObject(dataset='mnist', n_client=n_client, seed=23, unbalanced_sgm=0, rule='Dirichlet', rule_arg=0.6,data_path=data_path)
# # unbalanced
# # data_obj = DatasetObject(dataset='CIFAR100', n_client=n_client, seed=23, rule='iid', unbalanced_sgm=0.3, data_path=data_path)
#
# # Dirichlet (0.6)
...
# rho = 0.1
#
# [avg_cld_mdls, trn_cur_cld_perf, tst_cur_cld_perf] = train_MoFedSAM(data_obj=data_obj, act_prob=act_prob,
#                                     learning_rate=learning_rate, rho=rho,batch_size=batch_size, n_minibatch=n_minibatch,epoch=epoch,
#                                     com_amount=com_amount, print_per=print_per, weight_decay=weight_decay,
#                                     model_func=model_func, init_model=init_model, alpha_coef=alpha_coef,
#                                     sch_step=1, sch_gamma=1,save_period=save_period, suffix=suffix, trial=False,
...
# print_per = 5
#
# [avg_cld_mdls, trn_cur_cld_perf, tst_cur_cld_perf] = train_FedCM(data_obj=data_obj, act_prob=act_prob,
#                                     learning_rate=learning_rate, batch_size=batch_size, n_minibatch=n_minibatch,epoch=epoch,
#                                     com_amount=com_amount, print_per=print_per, weight_decay=weight_decay,
#                                     model_func=model_func, init_model=init_model, alpha_coef=alpha_coef,
#                                     sch_step=1, sch_gamma=1,save_period=save_period, suffix=suffix, trial=False,
#                                     data_path=data_path, lr_decay_per_round=lr_decay_per_round)
...
#
#
# [fed_mdls_sel, trn_perf_sel, tst_perf_sel] = train_FedGamma(data_obj=data_obj, act_prob=act_prob ,
#                                     learning_rate=learning_rate, rho=rho, batch_size=batch_size, n_minibatch=n_minibatch,
#                                     com_amount=com_amount, print_per=n_minibatch//2, weight_decay=weight_decay,
#                                     model_func=model_func, init_model=init_model,
#                                     sch_step=1, sch_gamma=1, save_period=save_period, suffix=suffix,
#                                     trial=False, data_path=data_path, lr_decay_per_round=lr_decay_per_round)
...
# kd_T = 4.0
#
# [avg_cld_mdls, trn_cur_cld_perf, tst_cur_cld_perf] = train_FedA1(data_obj=data_obj, act_prob=act_prob,
