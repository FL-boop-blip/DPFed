...
if __name__ == '__main__':
    root_dir_train =r"Folder/Data/Raw/sports_22/train"
    root_dir_test =r"Folder/Data/Raw/sports_22/test"
    ...
    train_set = Sports22Dataset(root_dir_train,transform=transforms_train)
    test_set = Sports22Dataset(root_dir_test,transform=transforms_train)
    # valid_set = Sports22Dataset(root_dir_val,transform=transforms_train)
