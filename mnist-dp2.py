...
# IID
data_obj = DatasetObject(dataset='mnist', n_client=n_client, seed=20, rule='iid',
                         unbalanced_sgm=0,
                         data_path=data_path)
...
[avg_cld_mdls, trn_cur_cld_perf, tst_cur_cld_perf] = train_DPMoFedSAM(data_obj=data_obj, act_prob=act_prob,
