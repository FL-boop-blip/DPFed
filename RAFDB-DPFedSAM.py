...
if __name__ == '__main__':
    ...
    # IID
    data_obj = DatasetObject(dataset='rafdb', n_clnt=n_client, seed=20, rule='iid',
                             data_path=data_path)
    ...
    data_obj = DatasetObject(dataset='rafdb', n_clnt=n_client, seed=20, rule='Dirichlet',rule_arg=0.3,
                             data_path=data_path)
    ...
    data_obj = DatasetObject(dataset='rafdb', n_clnt=n_client, seed=20, rule='Dirichlet',rule_arg=0.6,
                             data_path=data_path)
