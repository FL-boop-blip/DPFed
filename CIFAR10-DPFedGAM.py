...
if __name__ == '__main__':
    ...
    # IID
    data_obj = DatasetObject(dataset='CIFAR10', n_clnt=n_client, seed=20, rule='iid',
                             data_path=data_path)
    ...
    [avg_cld_mdls, trn_cur_cld_perf, tst_cur_cld_perf] = train_DPFedSGAM_KL(data_obj=data_obj, act_prob=act_prob,
    ...
    #
    #
    # [avg_cld_mdls, trn_cur_cld_perf, tst_cur_cld_perf] = train_DPFedGAM(data_obj=data_obj, act_prob=act_prob,
    #                                                                    learning_rate=learning_rate,
    #                                                                    batch_size=batch_size, rho=rho,epoch=epoch,n_minibatch=n_minibatch,
    #                                                                    com_amount=com_amount, print_per=print_per,
    #                                                                    weight_decay=weight_decay,
