...
if __name__ == '__main__':
    ...
    # IID
    data_obj = DatasetObject(dataset='fer2013', n_clnt=n_client, seed=20, rule='iid',
                             data_path=data_path)

    model_name = 'fer2013_LeNet'
    ...
    data_obj = DatasetObject(dataset='fer2013', n_clnt=n_client, seed=20, rule='Dirichlet',rule_arg=0.3,
                             data_path=data_path)
    ...
    data_obj = DatasetObject(dataset='fer2013', n_clnt=n_client, seed=20, rule='Dirichlet',rule_arg=0.6,
                             data_path=data_path)
